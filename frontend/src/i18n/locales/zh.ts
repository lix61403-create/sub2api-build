export default {
  ...
  auth: {
    ...
    forgotPasswordHint: '输入您的邮箱地址，我们将向您发送 6 位验证码，用于重新设置密码。',
    sendResetLink: '发送重置验证码',
    sendingResetLink: '发送中...',
    sendResetLinkFailed: '发送重置验证码失败，请重试。',
    resetEmailSent: '重置验证码已发送',
    resetEmailSentHint:
      '如果该邮箱已注册，您将很快收到密码重置验证码。请检查您的收件箱和垃圾邮件文件夹。',
    sendResetCode: '发送验证码',
    sendingResetCode: '发送中...',
    sendResetCodeFailed: '发送验证码失败，请重试。',
    resetCodeSent: '验证码已发送',
    resetCodeSentHint: '如果该邮箱已注册，您会收到一封包含 6 位验证码的邮件。验证码 15 分钟内有效。',
    resendCodeCountdown: '{seconds}秒后重发',
    verifyCode: '邮箱验证码',
