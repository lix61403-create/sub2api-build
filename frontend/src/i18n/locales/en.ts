export default {
  ...
  auth: {
    ...
    forgotPasswordHint: 'Enter your email address and we will send you a 6-digit code to reset your password.',
    sendResetLink: 'Send Reset Code',
    sendingResetLink: 'Sending...',
    sendResetLinkFailed: 'Failed to send reset code. Please try again.',
    resetEmailSent: 'Reset Code Sent',
    resetEmailSentHint: 'If an account exists with this email, you will receive a password reset code shortly. Please check your inbox and spam folder.',
    sendResetCode: 'Send Code',
    sendingResetCode: 'Sending...',
    sendResetCodeFailed: 'Failed to send code. Please try again.',
    resetCodeSent: 'Code Sent',
    resetCodeSentHint: 'If an account exists with this email, you will receive an email with a 6-digit code. The code is valid for 15 minutes.',
